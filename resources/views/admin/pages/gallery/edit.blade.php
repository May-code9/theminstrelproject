  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 push-1">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('postEditedImage') }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="card">

            <div class="card-body">
              <h5 class="m-0"> Edit Image Details</h5>
              <hr>
                  ...
                  <div class="row ">
                    <div class="col-lg-8 col-md-8">
                      <div class="form-group">
                        ...
                        <input id="image_title" name="image_title" type="text" value="{{ $galleryImages->image_title }}" class="form-control" required>
                    ...
                    <input id="id" name="id" type="hidden" value="{{ $galleryImages->id }}" class="form-control" >

                    <div class="col-lg-8 col-md-8">
                      <div class="form-group">
                        <label>Image Text</label>
                        <input id="image_text" name="image_text" type="text" value="{{ $galleryImages->image_text }}" class="form-control" required>
