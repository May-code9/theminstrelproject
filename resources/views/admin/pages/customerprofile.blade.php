...
<div class="wrapper-content">
  <div class="row  align-items-end  customer-profile-cover">
    <figure class="background"><img src="{{asset('img/normal.png')}}" alt="Social cover image"> </figure>
    <div class="container mb-2">
      <div class="row  align-items-center p-2">
        <figure class="social-profile-pic"><img src="{{asset('img/mayowa.png')}}" alt=""></figure>
        <div class="col-sm-16 col-lg-4 col-xl-4  profile-name">
          ...
          <button class="btn btn-primary  ml-1" >Follow</button>
        </div>
        <div class="col-16 col-sm-16 col-lg-9 col-xl-9 text-right d-flex">
          <div class="col col-sm-8 col-lg col-xl-8">
            <h4>User rating <small> (19 Rating)</small></h4>
            <h3><span class="text-warning"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i><i class="fa fa-star-o"></i></span>&nbsp;</h3>
          </div>
