                  ...
                  <div class="row ">
                    <div class="col-lg-8 col-md-8">
                      <div class="form-group">
                        ...
                        <input id="video_title" name="video_title" type="text" maxlength="25" class="form-control" required>
                    ...
                    <div class="col-lg-8 col-md-8">
                      <div class="form-group">
                        ...
                        <input id="link" name="link" type="text" class="form-control" placeholder="https://youtube.com..." required>
                        @if ($errors->has('link'))
                        <span class="help-block">
                ...
                <div class="col-md-10 ">
                  <div class="row ">
                    <div class="col-lg-8 col-md-8">
                      <div class="form-group">
                        <label>Date</label>
                        <input id="date_of_video" name="date_of_video" type="date" class="form-control" required>
                    ...
                    <div class="col-lg-8 col-md-8">
                      <div class="form-group">
                        <label>Time</label>
                        <input id="time_of_video" name="time_of_video" type="time" class="form-control" required>
