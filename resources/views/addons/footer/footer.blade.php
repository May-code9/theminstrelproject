  ...
  <div class="shell section-60">
    <div class="range range-lg-justify range-xs-center">
      ...
      <div class="cell-xs-10 cell-md-5 cell-lg-4 text-lg-left offset-top-50 offset-md-top-0">
        <h6 class="text-bold text-colour">Contact us</h6>
        <div class="text-subline"></div>
        <div class="offset-top-30">
          <ul class="list-unstyled contact-info list">
            <li>
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                <div class="unit-left"><span class="icon fa fa-phone text-middle icon-xs text-madison"></span></div>
                <div class="unit-body"><a href="callto:#" class="text-dark">08119055551,</a> <a href="callto:#" class="reveal-block reveal-md-inline-block text-dark">07066803471</a>
                </div>
              </div>
            </li>
            <li class="offset-top-15">
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                <div class="unit-left"><span class="icon fa fa-map-marker text-middle icon-xs text-madison"></span></div>
                <div class="unit-body text-left"><a href="#" class="text-dark">Port Harcourt, Rivers State</a></div>
              </div>
            </li>
            <li class="offset-top-15">
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                <div class="unit-left"><span class="icon fa-envelope-o text-middle icon-xs text-madison"></span></div>
                <div class="unit-body">
                  <a href="mailto:#" class="text-dark">contact@theminstrelproject.org</a><br>
                </div>
              </div>
            </li>
            <li class="offset-top-15">
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                <div class="unit-left"><span class="icon fa-envelope-o text-middle icon-xs text-madison"></span></div>
                <div class="unit-body">
                  <a href="mailto:#" class="text-dark">info@theminstrelproject.org</a><br>
                </div>
              </div>
            </li>
            <li class="offset-top-15">
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                <div class="unit-left"><span class="icon fa-envelope-o text-middle icon-xs text-madison"></span></div>
                <div class="unit-body">
                  <a href="mailto:#" class="text-dark">marketing@theminstrelproject.org</a>
                </div>
              </div>
            </li>
          </ul>
      ...
      <div class="cell-xs-10 cell-md-8 cell-lg-4 text-lg-left offset-top-50 offset-lg-top-0">
        <h6 class="text-bold text-colour">Useful Links</h6>
        <div class="text-subline"></div>
          ...
          <ul class="list-unstyled contact-info list">
            <li>
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                ...
                <div class="unit-body"><a href="{{ route('minstrelHome') }}" class="text-dark">Home
                </div>
              </div>
            </li>
            <li class="offset-top-15">
            ...
            <li class="offset-top-15">
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                <div class="unit-left"><span class="icon fa fa-arrow-right text-middle icon-xs text-madison"></span></div>
                <div class="unit-body">
                  <a href="#" class="text-dark">Donate</a>
                </div>
              </div>
            </li>
            <li class="offset-top-15">
